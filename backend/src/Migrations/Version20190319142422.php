 ...
 */
final class Version20190319142422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD person_id INT NOT NULL, ADD last_connnection DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP person_id, DROP last_connnection');
    }
}
